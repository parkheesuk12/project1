...
<table><caption>회 원 가 입</caption>
	<tr><th>아이디</th><td><input type="text" name="id" required="required" autofocus="autofocus"><input type="button" value="중복체크" onclick="dupChk()">
	...
	<!-- pattern="010-\d{3,4}-\d{4}" 전화번호는 010 - 숫자 3또는 4자 - 숫자 4자
		 ...
		 placeholder="010-1111-1111" 처음에 보여주고 데이터가 입력되면 나가 -->
