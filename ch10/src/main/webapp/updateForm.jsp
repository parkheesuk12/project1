...
<table><caption>회원 정보 수정</caption>
	...
	<tr><th>암호확인</th><td><input type="password" name="password2" required="required" autofocus="autofocus"></td></tr>
	...
	<tr><th>전화번호</th><td><input type="tel" name="tel" required="required"pattern="010-\d{3,4}-\d{4}" 
	                              title="전화형식 010-숫자3/4-숫자4" value="${member.tel }"></td></tr>
